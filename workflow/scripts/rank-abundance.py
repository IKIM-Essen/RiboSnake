...
def create_interactive_plot(index):
    ...
    fig = px.bar(x=sorted_abundance.index, y=sorted_abundance.values, labels={'x': 'Bacterial Names', 'y': 'Abundance'})
...
with open(str(snakemake.output.file), 'w') as f:
    ...
    f.write('  plot_div.innerHTML = \'<iframe src="plot_\' + index + \'.html" width="1000" height="800" frameborder="0"></iframe>\';\n')
    f.write('}\n')
    f.write('</script>\n')
    f.write('</body>\n</html>\n')
